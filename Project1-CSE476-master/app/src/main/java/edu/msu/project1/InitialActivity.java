...
public class InitialActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_ins, menu);
...
//            myIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            ...
            builder.setTitle("Error")
                    .setMessage("Username and password combination not found")
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            // continue with delete
                        }
    ...
    private String checkLogin(String userId, String password) {
        ...
        String query = LOAD_URL + "?user=" + userId + "&magic=" + MAGIC + "&pw=" + password + "&action=login";
    ...
    /* public void onSubmit(View view) {
        ...
        if ( TextUtils.isEmpty(p1) || TextUtils.isEmpty(p2)) {
            ...
            errorMessage.setText(getString(R.string.missingInput));
            return;
        }
